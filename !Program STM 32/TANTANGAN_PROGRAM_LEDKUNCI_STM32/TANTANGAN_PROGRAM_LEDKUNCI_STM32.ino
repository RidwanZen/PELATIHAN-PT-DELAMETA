...
void loop(){
  ...
  //LOGIKA TOMBOL 1
  if(ridwan_bacaT1==1 && kunci1==0){
    digitalWrite(ridwan_merah,HIGH);
    kunci1=1;
    delay(100);
  }else if(ridwan_bacaT1==1 && kunci1==1){
  ...
  //LOGIKA TOMBOL 2
  if(ridwan_bacaT2==1 && kunci2==0){
    digitalWrite(ridwan_kuning,HIGH);
    kunci2=1;
    delay(100);
  }else if(ridwan_bacaT2==1 && kunci2==1){
    digitalWrite(ridwan_kuning,LOW);
    kunci2=0;
    delay(100);
  }
  //LOGIKA TOMBOL 3
  if(ridwan_bacaT3==1 && kunci3==0){
    digitalWrite(ridwan_hijau,HIGH);
    kunci3=1;
    delay(100);
  }else if(ridwan_bacaT3==1 && kunci3==1){
